...
/**
 * FIXED: Converted Enums to Const Objects to satisfy 'erasableSyntaxOnly'
 * Usage: ErrorSeverity.CRITICAL or as a type: const x: ErrorSeverity = ...
 */
...
export interface BugBountyReport {
  id: string;
  severity: ErrorSeverity; // Reference the type created above
  category: ErrorCategory; // Reference the type created above
  title: string;
  description: string;
